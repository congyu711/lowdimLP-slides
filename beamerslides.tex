...
\input{BeamerTheme/beamerthemeSimple.sty}
% \useoutertheme{tree}
...
\begin{frame}{Aggregate the pwl convex functions}
    ...
    \begin{align*}
        ...
        &\cdots
    \end{align*}
    However, this is not possible for general pwl convex functions in $\R^d$.\footnote{see this \href{https://talldoor.uk/posts/2024-09-16-piecewise-linear.html}{blog post} for details.}
\end{frame}
